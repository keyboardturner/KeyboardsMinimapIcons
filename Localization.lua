...
if LOCALE == "ptBR" then
	...
	L["slashkmi"] = "/kmi"
	L["KMIVerbose"] = "Keyboard's Minimap Icons"
	L["IncompatibleFound"] = "Parece que você está rodando um addon incompatível: %s. Este addon não está mais disponível para atualizações. Deseja recarregar sua IU e desativá-lo?"
	L["DerangementMinimapBlips"] = "Ícones do Minimapa de Derangement"
	L["CurrentVersion"] = "Versão atual do addon"
	L["NotRecognized"] = "não é reconhecido. "
	...
	L["MinimapTextureTT"] = "Selecione uma textura para substituir os ícones do minimapa. Isso pode incluir ícones para nós de coleta e unidades NPC."
	L["Default"] = DEFAULT
	L["default"] = string.lower(DEFAULT)
	L["NodesAsCircles"] = "Nós como Círculos"
	L["circle"] = "círculo"
	L["NodesAsCirclesSG"] = "Nós como Círculos Brilhantes"
	L["BlueNodes"] = "Nós Azuis"
	L["blue"] = "azul"
	L["BlueNodesSG"] = "Nós Azuis Brilhantes"
	L["shiny"] = "brilhante"
	L["Enabling"] = "Ativando a opção %s."
	L["defaultDescript"] = "Esta opção inclui apenas nós de rastreamento menores para jogadores/PNJ amigáveis."
	L["circleDescript"] = "Esta opção inclui apenas nós de rastreamento menores para jogadores/PNJ amigáveis e círculos azuis para nós de coleta."
	L["circleShinyDescript"] = "Esta opção inclui nós de rastreamento menores para jogadores/PNJ amigáveis, círculos azuis para nós de coleta e ícones dourados brilhantes para nós de coleta especiais."
	L["blueDescript"] = "Esta opção inclui apenas nós de rastreamento menores para jogadores/PNJ amigáveis e nós de coleta azuis."
	L["blueShinyDescript"] = "Esta opção inclui nós de rastreamento menores para jogadores/PNJ amigáveis, nós de coleta azuis e ícones dourados brilhantes para nós de coleta especiais."
	L["ThanksForUsing"] = "Obrigado por usar %s. Este addon substitui os ícones padrão do minimapa, especialmente para o Rastreamento do Caçador, bem como para colorir nós de coleta em azul."
